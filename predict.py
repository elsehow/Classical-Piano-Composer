...
from lstm import create_network, vocab_size, get_item_names, prepare_sequences
...
def generate_output (pickle_file, weights_file):
    ...
    normalized_input, network_output, network_input = prepare_sequences(durations, n_vocab)
    # load model
